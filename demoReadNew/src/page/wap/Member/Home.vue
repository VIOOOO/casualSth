                    ...
                    <ul class="NewListBox">
                        <li v-for="(item,index) in newlist" :key="index">
                            <div class="NewList" v-touch:tap="$_handleClick(index,item.Id)" v-if="(item.thumbnail_pic_s&&!item.thumbnail_pic_s02&&!item.thumbnail_pic_s03)||item.thumbnail_pic_s&&item.thumbnail_pic_s02&&!item.thumbnail_pic_s03">
                                ...
                                <!-- <div class="righticon" v-on:click.stop="del(item)"><i class="icon iconfont icon-X"></i></div> -->
                            </div>
                            <div class="NewListIMG" v-touch:tap="$_handleClick(index,item.Id)" v-if="item.thumbnail_pic_s&&item.thumbnail_pic_s02&&item.thumbnail_pic_s03">
                                ...
                                <!-- <div class="shiwTime">
                                    ...
                                    <div class="right" v-on:click.stop="del(item)"><i class="icon iconfont icon-X"></i></div>
                                </div> -->
                            </div>
                    ...
                    <ul class="NewListBox">
                        <li v-for="(item,index) in newlist" :key="index">
                            <div class="NewList" v-touch:tap="$_handleClick(index,item.Id)" v-if="(item.thumbnail_pic_s&&!item.thumbnail_pic_s02&&!item.thumbnail_pic_s03)||item.thumbnail_pic_s&&item.thumbnail_pic_s02&&!item.thumbnail_pic_s03">
                                ...
                                <!-- <div class="righticon" @click.stop="del(item)"><i class="icon iconfont icon-X"></i></div> -->
                            </div>
                            <div class="NewListIMG" v-touch:tap="$_handleClick(index,item.Id)" v-if="item.thumbnail_pic_s&&item.thumbnail_pic_s02&&item.thumbnail_pic_s03">
                                <h2 class="Title">{{item.title}}</h2>
                                <dl class="imageBox">
                                ...
                                <!-- <div class="shiwTime">
                                    ...
                                    <div class="right" @click.stop="del(item)"><i class="icon iconfont icon-X"></i></div>
                                </div> -->
                            </div>
                            <div class="newDel"><i v-on:click.stop="del(item)" class="icon iconfont icon-X"></i></div>
                        </li>
    ...
    methods: {
        ...
        async BtoRefresh(loaded) {
            ...
            if (Result.StatusCode == "0") {
                ...
                // this.newlist = Result.Data
                this.newlist = oldArry.concat(Result.Data)
                this.NewId = this.newlist[this.newlist.length - 1].Id
            } else {
...
.vue-pull-to-wrapper > .action-block-bottom > .default-text {
    padding-bottom: 40px;
}
</style>
