            ...
            <div :class="{'wheel-bg6':true}">
              <div class="prize-list">
                <ul class="ulOne" :class="{'win':indexa===0&&prize_list.length==3}">
                  <li v-for="(item,index) in arrOne" :key="index" :class="{'win':index===indexa}" :style="{ zIndex: item.zIndex,transform: item.deg }"></li>
                </ul>
                <ul class="ulTwo" :class="{'win':indexa===arrOne.length-1}">
                  <li v-for="(item,index) in arrTwo" :key="index" :class="{'win':index===indexb}" :style="{ zIndex: item.zIndex,transform: item.deg }"></li>
              ...
              <div class="prize-list">
                <div class="prize-item" v-for="(item,index) in prize_list" :key="index" :style="{transform:item.troter,width:item.width}">
                  <div class="prize-pic">
                    <img v-if="item.prizeType==0" src="../assets/img/bean_500.png">
                    <img v-if="item.prizeType==1" src="../assets/img/bean_five.png">
                    <img v-if="item.prizeType==2" src="../assets/img/bean_one.png">
                    <img v-if="item.prizeType==3" src="../assets/img/point_ten.png">
                  </div>
...
.content {
  .conts {
    ...
    .box {
      ...
      .pointer {
        ...
        background: url(../assets/img/draw_btn.png) top center no-repeat;
        background-size: 100%;
        p {
          font-size: 0.36rem;
          color: #ff4027;
      ...
      .boxbg {
        width: 6.6rem;
        height: 6.6rem;
        background: url(../assets/img/draw_wheel.png) top center no-repeat;
        background-size: 100%;
        padding: 0.5rem;
        .turn {
          width: 5.6rem;
  ...
  .popup {
    ...
    .popbox {
      ...
      right: 0;
      margin: auto;
      background: url(../assets/img/congratulation.png) top center no-repeat;
      background-size: 100%;
      text-align: center;
      .img {
        width: 3.06rem;
        ...
        margin-top: 1.07rem;
        margin-left: 1.1rem;
        background: url(../assets/img/give_up.png) top center no-repeat;
        background-size: 100%;
      }
      .img1 {
        background: url(../assets/img/give_up.png) top center no-repeat;
    ...
    .close {
      width: 0.5rem;
      height: 0.5rem;
      background: url(../assets/img/close_store.png) top center no-repeat;
      background-size: 100%;
      position: absolute;
      top: 75%;
      left: 0;
